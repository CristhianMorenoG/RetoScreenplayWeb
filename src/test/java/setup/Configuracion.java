...
public class Configuracion {
    private static final String POPUPS = "--disable-popup-blocking";
    private static final String SWITCHES = "--remote-allow-origins=*";
    private static final String ACTOR = "Cristhian";
    ...
    private void setUplog4j() {
        PropertyConfigurator.configure(USER_DIR.value() + LOG4J_PROPERTY_PATH.getValue());
    }
